...
///
/// Built on 2024-11-28 at 14:06 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String get Your_beauty_is_a_journey_that_begins_with_our_services =>
      ' جمالكِ رحلةٌ تبدأُ بخدماتِنا!';
  ...
  String get confirm_password_not_empty =>
      'يجب ألا يكون تأكيد كلمة المرور فارغًا';
...
class _TranslationsEn implements Translations {
  ...
  @override
  String get Makeup_and_eyelashes => 'Makeup and eyelashes';

  @override
  String get Your_beauty_is_a_journey_that_begins_with_our_services =>
      'Your beauty is a journey that begins with our services!';
  ...
  @override
  String get discover_the_best_foods =>
      'Discover the best foods from over 1,000 ';
  ...
  @override
  String get something_error_try_again =>
      'Something Happened Error Please Try Again';
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'Makeup_and_eyelashes':
        return 'المكياجُ والرموشُ';
      case 'Your_beauty_is_ journey_that_begins_with_our_services!':
        return ' جمالكِ رحلةٌ تبدأُ بخدماتِنا!';
      case 'Your_beauty_is_a_journey_that_begins_with_our_services':
        return ' جمالكِ رحلةٌ تبدأُ بخدماتِنا!';
      case 'add_details_login':
        return 'أضف التفاصيل الخاصة بك لتسجيل الدخول';
      case 'add_your_details_to_sign_up':
        return 'أضف التفاصيل الخاصة بك للتسجيل';
      case 'address':
        return 'العنوان';
      case 'address_not_empty':
        return 'يجب ألا يكون العنوان فارغًا';
      case 'ahmed':
        return 'احمد';
      ...
      case 'confirm_password_not_empty':
        return 'يجب ألا يكون تأكيد كلمة المرور فارغًا';
      case 'create_an_account':
        return 'إنشاء حساب';
      case 'delivery_to':
        return 'التوصيل إلى';
      case 'discover_the_best_foods':
        return 'اكتشف أفضل الأطعمة من أكثر من 1000';
      case 'donot_have_an_account ':
      ...
      case 'sign_up':
        return 'انشاء حساب';
      case 'something_error_try_again':
...
extension on _TranslationsEn {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'Makeup_and_eyelashes':
        return 'Makeup and eyelashes';
      case 'Your_beauty_is_ journey_that_begins_with_our_services!':
        return 'Your beauty is a journey that begins with our services!';
      case 'Your_beauty_is_a_journey_that_begins_with_our_services':
        return 'Your beauty is a journey that begins with our services!';
      case 'add_details_login':
      ...
      case 'sign_up':
        return 'Sign Up';
      case 'something_error_try_again':
        return 'Something Happened Error Please Try Again';
      default:
        return null;
    }
  }
